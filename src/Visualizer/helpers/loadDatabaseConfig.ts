import type { EdgeConfig, SchemaColors, TableConfig, TablePositions } from "../types";
...
export const loadDatabaseConfig = async (databaseName: string) => {
  ...
  const tables = (await import(`../../config/databases/${databaseName}/tables.ts`)).default as TableConfig[];
